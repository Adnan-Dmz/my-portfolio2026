...
const Home = () => {
    ...
    const texten = [
        ...
        "Creating Clean & Professional Web Experiencews",
        ...
        <div className="divhome">
            <div className="nameclassdiv">
                <h1 className={`myname ${isLight ? "mynamelight" : "mynamedark"}`}>
                    {isPersian ? "عدنان دمی زاده" : "AdnanDamizadeh"}
                </h1>
                <div className={`underline ${isLight ? "underlinelight" : "underlinedark"}`}></div>
            </div>
            <div className="textdiv">
                <h3 className={`text ${isLight ? "textlight" : "textdark"}`}>{isPersian ? textfa[index] : texten[index]}</h3>
            </div>
         ...
         <div className="divaboutt">
            ...
            <div className="divmotherskills">
                ...
                <div className={`divskills ${isLight ? "divskillsligh" : "divskillsdark"}`}>
                     <p  className={`tittle ${isLight ? "tittlelight" : "tittledark"}`}>{isPersian? "مهارت ها" :"SKILLS"}</p>
